...
import { signInWithPopup, createUserWithEmailAndPassword, signInWithEmailAndPassword, getAdditionalUserInfo } from 'firebase/auth';
import '../TagInput.css';
      ...
      <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 font-sans selection:bg-[#ffbd59]/30">
        <div className="w-full max-w-md relative text-center">
          ...
          <div className="space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <button onClick={handleGoogleAuth} className="w-full py-3.5 rounded-xl bg-[#fefefe] text-black font-bold hover:bg-[#fefefe]/90 transition-all flex items-center justify-center gap-2">
      ...
      <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 font-sans">
        <div className="w-full max-w-md relative">
          ...
          <form onSubmit={handleManualLogin} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="w-full py-3.5 rounded-xl bg-[#ffbd59] text-black font-bold hover:bg-[#ffbd59]/90 disabled:opacity-50 transition-all pt-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        {step === 2 && (
          <form onSubmit={handleNext} className="space-y-4 animate-in fade-in duration-300">
            ...
            <div>
              ...
              <select value={formData.gender} onChange={(e) => setFormData({...formData, gender: e.target.value})} required className="w-full bg-[#fefefe]/5 border border-[#fefefe]/10 rounded-xl px-4 py-3 text-[#fefefe] focus:outline-none focus:ring-2 focus:ring-[#ffbd59]">
            ...
            <div>
              ...
              <select value={formData.country} onChange={(e) => setFormData({...formData, country: e.target.value})} required className="w-full bg-[#fefefe]/5 border border-[#fefefe]/10 rounded-xl px-4 py-3 text-[#fefefe] focus:outline-none focus:ring-2 focus:ring-[#ffbd59]">
        ...
        {step === 4 && (
          <form onSubmit={handleSignupSubmit} className="animate-in fade-in duration-300">
            ...
            <div className="flex gap-3">
              <button type="button" onClick={handleBack} className="flex-1 py-3.5 rounded-xl bg-[#fefefe]/10 text-[#fefefe]/80 font-medium hover:bg-[#fefefe]/20 transition-all">Back</button>
              <button type="submit" disabled={loading || formData.interests.length === 0} className="flex-1 py-3.5 rounded-xl bg-[#ffbd59] text-black font-bold hover:bg-[#ffbd59]/90 disabled:opacity-50 transition-all">
